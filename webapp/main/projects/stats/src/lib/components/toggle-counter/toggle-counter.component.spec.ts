...
import { ToggleCounterComponent } from './toggle-counter.component';


describe('ToggleCounterComponent', () => {
  let component: ToggleCounterComponent;
  let fixture: ComponentFixture<ToggleCounterComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ToggleCounterComponent);
