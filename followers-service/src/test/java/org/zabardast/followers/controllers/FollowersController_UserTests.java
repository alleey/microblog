...
@ActiveProfiles("test")
class FollowersController_UserTests {
	...
	void userCanAddFollowerToOwn() throws Exception {
		...
		Follower follower = MockFollowersData.createFollower(MockFollowersData.UserIdAdmin, MockFollowersData.UserIdGuest);
		Mockito.when(followerService
				.addFollower(MockFollowersData.UserIdAdmin, MockFollowersData.UserIdGuest))
				.then(r -> follower);
		RequestBuilder requestBuilder = MockMvcRequestBuilders
				.put("/api/v1/users/{id}/following", MockFollowersData.UserIdGuest)
				.accept(MediaType.APPLICATION_JSON)
				.contentType(MediaType.APPLICATION_JSON)
				.content(MockFollowersData.objectToJson(MockFollowersData.UserIdAdmin));
	...
	void userCanRemoveFollowerFromOwn() throws Exception {
		...
		Mockito.doNothing().when(followerService)
				.removeFollower(MockFollowersData.UserIdAdmin, MockFollowersData.UserIdGuest);
		RequestBuilder requestBuilder = MockMvcRequestBuilders
