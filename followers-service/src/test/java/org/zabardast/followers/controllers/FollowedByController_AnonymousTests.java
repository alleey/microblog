...
@ActiveProfiles("test")
class FollowedByController_AnonymousTests {
	...
	void getAllFollowers() throws Exception {
		...
		Mockito.when(followingService.listFollowedBy(MockFollowersData.UserIdGuest, pageable)).then(r -> page);
		RequestBuilder requestBuilder = MockMvcRequestBuilders
				.get("/api/v1/users/{id}/followedBy", MockFollowersData.UserIdGuest)
	...
	void getAllFollowersCustomPaging() throws Exception {
		...
		Mockito.when(followingService.listFollowedBy(MockFollowersData.UserIdGuest, pageable)).then(r -> page);
		RequestBuilder requestBuilder = MockMvcRequestBuilders
				.get("/api/v1/users/{id}/followedBy?page=0&size=1", MockFollowersData.UserIdGuest)
				.accept(MediaType.APPLICATION_JSON);
