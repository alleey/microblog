...
public class UserProfileToMapConverter implements Converter<UserProfile, Map<String, Object>> {

    public static final String ATTR_ID = "userId";
    public static final String ATTR_REF = "ref";

    @Override
    public Map<String, Object> convert(MappingContext<UserProfile, Map<String, Object>> context) {
